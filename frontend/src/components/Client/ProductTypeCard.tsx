...
export default function ProductTypeCard({
  ...
  return (
    <div className="font-primary font-bold flex flex-col justify-center items-center w-max h-max md:w-max md:h-max">
      <div className="w-[60px] h-[60px] aspect-square  rounded-full bg-[#f5f5f5] object-cover md:w-[110px] md:h-[110px]">
        <img
          src={productType.img}
          className="w-[60px] h-[60px] aspect-square  rounded-full bg-[#f5f5f5] object-cover md:w-[110px] md:h-[110px]"
